...
public class VideoJuego3 {
	public static void main(String[] args) {
		...
		ArrayList<Soldado> ejercito0 = crearSoldados(tablero, 0);  // Creo y obtengo los soldados del tablero
		ArrayList<Soldado> ejercito1 = crearSoldados(tablero, 1);
		...
		for(int fila = 0; fila < 10; fila++) {
            for(int columna = 0; columna < 10; columna++) {
                if(x.get(fila).get(columna).getNombre() != null)
                	System.out.print("| " +  x.get(fila).get(columna).getNombre().charAt(7) + " ");
                else
                    System.out.print("| _ ");
            }
            System.out.println("|");
	...
	public static ArrayList<Soldado> crearSoldados(ArrayList<ArrayList<Soldado>> x, int p) {
		...
		System.out.println("# de soldados del Ejercito " + p + " => " + numeroSoldados);
